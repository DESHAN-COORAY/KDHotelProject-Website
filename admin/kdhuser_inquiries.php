...
<head>
  ...
  <title>KD Hotel | KDH User Inquiries</title>
...
<body>
  ...
  <!-- ======= Sidebar ======= -->
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="kdhuser_inquiries.php">
  ...
  <!-- ======= Main ======= -->
    <main id="main" class="main">
      ...
      <div class="pagetitle">
        <h1>KDH User Inquiries</h1>
        <nav>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
            <li class="breadcrumb-item active">KDH User Inquiries</li>
          </ol>
        </nav>
      </div><!-- End Page Title -->
                            ...
                            <center>
                              <table class="table table-bordered table-hover mb-4">
                                  <thead>
                                      ...
                                      <th scope="col" class="col-5">INQUIRY</th>
                                ...
                                ?>
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            &emsp;
                                            <a href="<?php echo SITE_URL; ?>admin/delete_inquiry.php?i_id=<?php echo $I_id; ?>" class="p-2 btn btn-danger"><i class="fas fa-trash"></i></a>
                                          </td>
                                        </tr>
                                <?php
                                      }
